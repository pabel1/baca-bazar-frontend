    ...
    <CommonLayout>
      <div className="w-full px-20 my-14">
        ...
        <div className="w-full flex flex-col mt-10 gap-8">
          ...
          <p className="text-[1rem] text-justify text-lightText">
            STEP Communications is one of the very few agencies in the world
            which cares about the financial challenges of its clients
          </p>
