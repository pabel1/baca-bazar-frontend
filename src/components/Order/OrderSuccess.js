...
const OrderSuccess = () => {
  ...
  const createAndDownloadPdf = () => {
    axios
      .post("/api/v1/create/invoice", state)
      .then(() =>
        axios.get("/api/v1/fetch/invoicepdf", { responseType: "blob" })
      )
      .then((res) => {
  ...
  return (
    <CommonLayout>
      <div className="border flex flex-col gap-y-6 items-center border-secondary rounded-lg p-4">
