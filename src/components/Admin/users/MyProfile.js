  ...
  return (
    <CommonLayout>
      <div className=" container  mx-auto rounded-xl bg-[#f7f5f3] mt-7 p-[2rem]">
        ...
        {/* profile tabs */}
        <div className=" w-full md:w-[70%]  flex justify-between flex-wrap gap-4 mb-8">
          <button
            onClick={() => toggleTab(1)}
            className=" whitespace-pre px-4 py-3 text-primaryColor border border-primaryColor flex justify-center items-center rounded-xl"
          >
            <ImProfile size={25} /> My Profile
          </button>
          <button
            onClick={() => toggleTab(2)}
            className="whitespace-pre px-4 py-3 text-primaryColor border border-primaryColor flex justify-center items-center rounded-xl"
          >
            <AiOutlineUnorderedList size={25} /> My Orders
          </button>
          <button
            onClick={() => toggleTab(3)}
            className="whitespace-pre px-4 py-3 text-primaryColor border border-primaryColor flex justify-center items-center rounded-xl"
          >
            <FaUserEdit size={25} /> Edit Profile
          </button>
          <button
            onClick={() => toggleTab(4)}
            className="whitespace-pre px-4 py-3 text-primaryColor border border-primaryColor flex justify-center items-center rounded-xl"
          >
            <CgLastpass size={25} /> Update Password
          </button>
        </div>
        ...
        >
          ...
          >
            <div className="w-[60%] flex flex-col gap-y-4 justify-center items-start">
            ...
            <div className="container pt-4  md:w-[40%] flex gap-2 justify-center items-center">
              <img
                className=" w-44 h-44 object-cover rounded-full transition-all duration-[0.3s] hover:scale-[1.1]"
