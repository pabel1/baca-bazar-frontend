...
const CreateDiscountProduct = () => {
  ...
  const handleCreateSingleProduct = async () => {
    ...
    if (isOk) {
      const res = await createDiscountProductAPI(state);
  ...
  const handleUpload = (e) => {
    ...
    const sendFile = async () => {
      ...
      const res = await uploadCSVDiscountsAPI(formdata); // api call
    ...
    <div>
      ...
      <div className="w-full flex flex-col justify-center items-start gap-6">
        ...
        <div className="w-full flex justify-between flex-wrap md:flex-nowrap gap-4 ">
          ...
          <div className="w-full md:w-[40%] h-52 flex flex-col">
      ...
      <div className="container  w-full flex justify-center items-center gap-6">
        <div className="w-full flex gap-x-4">
          <label
            htmlFor="csvfile"
            className="md:w-[50%] w-full flex justify-center items-center outline-none px-1 py-[0.5rem] rounded-xl border border-secondary"
          >
            {csvFilename}
            <FaFileCsv size={30} className="text-secondary" />
